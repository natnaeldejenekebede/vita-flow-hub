		...
		extend: {
			...
			keyframes: {
				...
				'logoGlow': {
					...
					'100%': {
						textShadow: '0 0 30px hsl(var(--secondary)), 0 0 60px hsl(var(--secondary))'
					}
				},
				'parallaxShift': {
			...
			animation: {
				...
				'parallaxShift': 'parallaxShift 20s ease-in-out infinite',
				'blinkCursor': 'blinkCursor 1s infinite',
				'stickyPulse': 'stickyPulse 2s infinite',
